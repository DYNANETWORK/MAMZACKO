...
from MAMZACKO.modules import ALL_MODULES
from MAMZACKO.modules.helper_funcs.alternate import typing_action
from MAMZACKO.modules.helper_funcs.chat_status import is_user_admin
from MAMZACKO.modules.helper_funcs.misc import paginate_modules
from MAMZACKO.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
Hello there, I'm [MAMZACKO](https://telegra.ph/file/ea68644f59bdaf57fd61e.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add MAMZACKO to your group 💫",
            url="t.me/SUKHPAL_KHERERA?startgroup=true",
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [MAMZACKO](https://telegra.ph/file/ea68644f59bdaf57fd61e.jpg)
...
Support them  [N](t.me/MAMBA_X_SUPPORT),[MAMZACKO](t.me/MAMBA_X_SUPPORT),"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("MAMZACKO.modules." + module_name)
...
@run_async
def MAMZACKO_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by @SUKHPAL_KHERERA.* "
            f"\n\n 🔥 Join [MAMBA NETWORK](https://t.me/MAMBA_NETWORK) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [support](https://t.me/MAMBA_NETWORK).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\n{dispatcher.bot.first_name}'s source code was rewritten by @SUKHPAL_KHERERA and @MAMBAMUSIC_ASSISTANT"
...
def main():
    ...
    if SUKHPAL443 == 5038173179:
         print ("MAMBAMUSIC_ASSISTANT ADDED SIR ")
    else:
